...
public class IN_informe {
    ...
    public void Iniciar_insercion() {
        ...
        JFrame frame = new JFrame("Insertar informe");
        ...
        boton_anadir.addActionListener(e -> anadirInforme());
        ...
        try {
            ...
            for (String partido : listaPartidos) {
                ...
                if (!equipos[0].equals("Error")) {
                    ...
                    if (!coInforme.tieneInforme(idPartido)) { // Solo agregar partidos sin informe
    ...
    private void anadirInforme() {
        if (partido_usuario.getSelectedItem() != null) {
            ...
            if (!localyvisi[0].equals("Error")) {
                ...
                Informe informe = new Informe(idArbitro, idPartido, nAmarillas, nRojas, localyvisi[0], localyvisi[1]);
                coInforme.anadirInforme(informe);

                JOptionPane.showMessageDialog(null, "Informe añadido correctamente.");
            ...
            JOptionPane.showMessageDialog(null, "Seleccione un partido para crear el informe.");
        }
    }
