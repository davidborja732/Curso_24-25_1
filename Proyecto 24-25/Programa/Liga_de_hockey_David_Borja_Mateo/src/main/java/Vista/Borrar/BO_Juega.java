...
public class BO_Juega {
    ...
    // Método para iniciar el proceso de eliminación de equipos de un partido
        ...
        botonBorrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (filaSeleccionada != -1) { // Verifica si se ha seleccionado alguna fila
                    ...
                    eliminar.Eliminar_juega(juega, modeloTabla); // Llama al método para eliminar el equipo del partido
