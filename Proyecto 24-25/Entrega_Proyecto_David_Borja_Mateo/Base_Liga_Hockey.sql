...
(9,1,5,5,9),
(10,0,4,3,10);
-- Elimina la clave foránea jugador_ibfk_2 de la tabla jugador
ALTER TABLE jugador DROP FOREIGN KEY jugador_ibfk_2;
-- Añade nuevamente la clave foránea jugador_ibfk_2 en la columna ID_eq de la tabla jugador,
-- estableciendo una relación con la columna ID_eq de la tabla equipo.
